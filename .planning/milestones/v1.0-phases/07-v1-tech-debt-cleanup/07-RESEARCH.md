...
describe('sync -> status flow', () => {
  it('should show project counts after sync', async () => {
    // Run sync
    const syncResult = await container.exec(['npx', 'nx', 'polyrepo-sync'], {

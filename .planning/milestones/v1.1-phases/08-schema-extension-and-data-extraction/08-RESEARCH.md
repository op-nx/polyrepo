...
**What goes wrong:** Constructing the package.json path using the _rewritten_ root (`.repos/repo-b/libs/my-lib`) instead of composing from `workspaceRoot` + `.repos/<alias>` + original `node.data.root`.

...
plan: 02
subsystem: git
tags: [status-executor, aligned-output, auto-fetch, working-tree, warnings, project-counts]
...
tech-stack:
  added: []
  patterns: [parallel-auto-fetch-before-state-gather, warning-accumulation-per-repo]

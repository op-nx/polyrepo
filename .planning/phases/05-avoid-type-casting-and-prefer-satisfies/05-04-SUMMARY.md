...
plan: 04
subsystem: tests
tags: [sifers, typed-mocks, eslint-disable, vitest, test-refactoring, type-safety]
...
tech-stack:
  added: []
  patterns: ["SIFERS setup() returning test state", "vi.mocked() for overloaded functions", "import type * as Mod for vi.mock factories", "getNode/getTarget typed helpers for Record access"]
